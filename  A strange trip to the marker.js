...
const lochNess = (string) => {
    if (string.includes('tree fiddy')){
        return true;
    } else if (string.includes('3.50')){
        return true;
    } else if (string.includes('three fifty')){
        return true;
    }else return false;
 }
 
 var str = "Its always gonna be about tree fiddy."
 var str1 = "Its going to be twelve dollars"
 var str2 = "The total is 3.50"
 
 console.log(lochNess(str))
 console.log(lochNess(str1))
 console.log(lochNess(str2))